...
import ygg.io.subs.ass.collection.StylesCollectionConf;
import ygg.io.subs.ass.rendersubs.YggyApply;
import ygg.io.subs.ass.model.StylesCollectionTableModel;
import ygg.io.subs.ass.renderer.StylesCollectionTableRenderer;
...
public class StylesDialog extends javax.swing.JDialog {
    ...
    public int showScript(){
        try{
            ...
            ASS.Save("test.ass", ass);
            BufferedImage img = YggyApply.getSubsImage("test.ass", Time.create(5L));
