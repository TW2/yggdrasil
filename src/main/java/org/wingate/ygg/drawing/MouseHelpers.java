...
public class MouseHelpers {
    ...
    private final ImageIcon ADD_POINT = new ImageIcon(
            getClass().getResource("/images/48 mouse_helper_plus addpoint.png"));
    private final ImageIcon MOVE_POINT = new ImageIcon(
            getClass().getResource("/images/48 mouse_helper_plus move.png"));
    private final ImageIcon SELECT_ORIGIN = new ImageIcon(
            getClass().getResource("/images/48 mouse_helper_plus origin.png"));
    private final ImageIcon SELECT_LAST = new ImageIcon(
            getClass().getResource("/images/48 mouse_helper_plus last.png"));
