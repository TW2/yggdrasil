...
import org.wingate.ygg.helper.ISO_3166;
...
public class AssTableModel extends DefaultTableModel {
    ...
    public Object getValueAt(int row, int column) {
        ...
        switch(column){
            ...
            case 3 -> { return ev.getStartTime(); }
            case 4 -> { return ev.getEndTime(); }
            case 5 -> { return AssTime.substract(ev.getStartTime(), ev.getEndTime()); }
    ...
    public void setValueAt(Object value, int row, int column) {                
        ...
        switch(column){
            ...
            case 3 -> { ev.setStartTime((AssTime)value); }
            case 4 -> { ev.setEndTime((AssTime)value); }
            case 5 -> { setFromDuration(ev, (AssTime)value); }
    ...
    private void setFromDuration(AssEvent ev, AssTime duration){
        ev.setEndTime(AssTime.addition(ev.getStartTime(), duration));
    }
    ...
    public void add(AssEvent.LineType l, int layer, String start, String end, String style,
        ...
        ev.setStartTime(AssTime.create(start));     // Start time
        ev.setEndTime(AssTime.create(end));         // End time
