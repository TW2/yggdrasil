...
This tool can encrypt and decrypt! In Yggdrasil and with this tool you can only decrypt your surname, ip and port. Password is set but the decrypt method cannot give the password unless you have the 'hello' which is not a valid password.
